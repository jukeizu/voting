...
func (s ValidationService) VoterBallot(shortId string, voterId string, serverId string) ([]BallotOption, error) {
	return s.service.VoterBallot(shortId, voterId, serverId)
}
